"""
Configuration for CareerAI Agent
"""
import os
...
# Backwards compatibility for old backend code
...
CAREER_ADAPTER_PATH = AGENT_DIR / "career_adapter"  # For fine-tuned career model
USE_CAREER_ADAPTER = True  # Set to True after fine-tuning

# Persona / MadSci settings (Legacy support)
PHRASES_FILE = SRC_DIR / "prompts" / "dylan_phrases.csv"
ADAPTER_CHECKPOINT = PROJECT_ROOT / "madsci_dylan_adapter" / "checkpoint-96"
