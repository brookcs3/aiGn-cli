...
type Options struct {
	...
	ViewportHeight      int           `name:"viewport-height" help:"Fixed viewport height in lines (0 for full screen, -1 for auto-fit content)" default:"0" env:"GUM_PAGER_VIEWPORT_HEIGHT"`
