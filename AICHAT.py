...
def main():
    ...
    parser.add_argument("--model", type=str, default="/Users/cameronbrooks/Library/Mobile Documents/com~apple~CloudDocs/Working Directory/WINTER 2026/SENIOR SOFTWARE ENGIN PROJECT (CS_462_400_W2026)/Module 2 - Career Preparation/aiGn/cli/smollm2-135m.gguf")
    ...
    if args.chat:
        ...
        while True:
            ...
            # If piped, exit after first response
            if is_piped:
                break
    else:
        # Single-shot mode
